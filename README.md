...
In the file [best_configurations_for_ResESN_variants.sh](best_configurations_for_ResESN_variants.sh) you can find how to run the best ResESN variants for each experiment in the paper.

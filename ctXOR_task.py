...
if args.ortho == 'random':
    namefile = 'ctXOR_log_ResESN'
elif args.ortho == 'cycle':
    namefile = 'ctXOR_log_ResESN_C'
elif args.ortho == 'identity':
    namefile = 'ctXOR_log_ResESN_I'
elif args.ortho == 'null':
    namefile = 'ctXOR_log_ESN'
else:
...
if args.Euler:
    namefile = 'ctXOR_log_EuESN'

if args.ES2N:
    namefile = 'ctXOR_log_ES2N'
    args.beta = 1 - args.alpha

namefile += '_delay' + str(args.delay)
...
(train_dataset, train_target), (valid_dataset, valid_target), (test_dataset, test_target) = get_ctXOR(delay=args.delay)

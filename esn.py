...
class EulerReservoirCell(torch.nn.Module):
    def __init__(self, input_size, units, input_scaling=1., spectral_radius=0.99,
                 ...
                 bias_bool=True, alpha=0, beta=1, distrib='uniform', nonlin='tanh',
                 effective_rescaling=True, bias_scaling=None,
                 epsilon=1.0, gamma=1.0, recur_scaling=1.0):  
        """ Shallow reservoir to be used as cell of an Euler Recurrent Neural Network.
        ...
        :param bias_scaling: If None, then rescale the bias vectore with the
            scalar value input_scaling.
        :param epsilon: Euler step.
        :param gamma: diffusive term.
        :param recur_scaling: real positive value for scaling the recurrent matrix.
        """
        super().__init__()
...
class ReservoirLayer(torch.nn.Module):
    def __init__(self, input_size, units, input_scaling=1., spectral_radius=0.99,
                 ...
                 bias_bool=True, alpha=0, beta=1, distrib='uniform', nonlin='tanh',
                 effective_rescaling=True, bias_scaling=None, 
                 Euler=False, epsilon=1.0, gamma=1.0, recur_scaling=1.0):
        ...
        super().__init__()
        if Euler:
            self.net = EulerReservoirCell(input_size, units, input_scaling,

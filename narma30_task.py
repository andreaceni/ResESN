...
if args.ortho == 'random':
    namefile = 'narma30_log_ResESN'
elif args.ortho == 'cycle':
    namefile = 'narma30_log_ResESN_C'
elif args.ortho == 'identity':
    namefile = 'narma30_log_ResESN_I'
elif args.ortho == 'null':
    namefile = 'narma30_log_ESN'
else:
...
if args.Euler:
    namefile = 'narma30_log_EuESN'

if args.ES2N:
    namefile = 'narma30_log_ES2N'
...
(train_dataset, train_target), (valid_dataset, valid_target), (test_dataset, test_target) = get_narma30(args.lag)

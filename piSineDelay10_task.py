...
from utils import get_piSineDelay10, coESN, check
...
if args.ortho == 'random':
    namefile = 'piSineDelay10_log_ResESN'
elif args.ortho == 'cycle':
    namefile = 'piSineDelay10_log_ResESN_C'
elif args.ortho == 'identity':
    namefile = 'piSineDelay10_log_ResESN_I'
elif args.ortho == 'null':
    namefile = 'piSineDelay10_log_ESN'
else:
...
if args.Euler:
    namefile = 'piSineDelay10_log_EuESN'

if args.ES2N:
    namefile = 'piSineDelay10_log_ES2N'
    args.beta = 1 - args.alpha

if args.ergodic:
    namefile = 'ergodic_' + namefile
...
if args.ergodic:
    (train_dataset, train_target), (valid_dataset, valid_target), (test_dataset, test_target) = get_piSineDelay10(args.lag)
else:
    (train_dataset, train_target), (valid_dataset, valid_target), (test_dataset, test_target) = get_piSineDelay10(args.lag)
